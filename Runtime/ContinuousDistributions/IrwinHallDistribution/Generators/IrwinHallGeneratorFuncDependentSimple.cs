...
namespace Zor.RandomGenerators.ContinuousDistributions
{
	...
	/// </summary>
	public sealed class IrwinHallGeneratorFuncDependentSimple : IIrwinHallGenerator
	{
		[NotNull] private Func<float> m_iidFunc;
		private byte m_iids;

		/// <summary>
		/// Creates an <see cref="IrwinHallGeneratorFuncDependentSimple"/> with the specified parameters.
		/// </summary>
		/// <param name="iidFunc">
		...
		/// Copy constructor.
		/// </summary>
		public IrwinHallGeneratorFuncDependentSimple([NotNull] IrwinHallGeneratorFuncDependentSimple other)
		{
