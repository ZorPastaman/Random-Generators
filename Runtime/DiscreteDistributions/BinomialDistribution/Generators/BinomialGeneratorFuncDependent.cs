...
namespace Zor.RandomGenerators.DiscreteDistributions
{
	...
	/// using <see cref="BinomialDistribution.Generate(Func{float},BinomialDistribution.Setup,byte)"/>.
	/// </summary>
	public sealed class BinomialGeneratorFuncDependent : IBinomialGenerator
	{
		...
		public BinomialGeneratorFuncDependent([NotNull] Func<float> iidFunc, float probability,
			byte upperBound)
		{
			m_iidFunc = iidFunc;
		...
		public int Generate()
		{
			return BinomialDistribution.Generate(m_iidFunc, m_setup, m_upperBound);
		}
	}
}
