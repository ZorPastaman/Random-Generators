...
namespace Zor.RandomGenerators.ContinuousDistributions.IndependentDistributions
{
		...
		where T : IContinuousGenerator
	{
		...
		/// <summary>
		/// Creates an <see cref="AcceptanceRejectionFuncGeneratorDependentSimple{T}"/>
		...
		/// </param>
		public AcceptanceRejectionFuncGeneratorDependentSimple([NotNull] T valueGenerator,
		...
		/// Copy constructor.
		/// </summary>
		public AcceptanceRejectionFuncGeneratorDependentSimple(
			[NotNull] AcceptanceRejectionFuncGeneratorDependentSimple<T> other)
		{
