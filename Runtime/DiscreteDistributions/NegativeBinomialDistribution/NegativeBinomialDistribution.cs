...
namespace Zor.RandomGenerators.DiscreteDistributions
{
	...
	public static class NegativeBinomialDistribution
	{
		...
		{
			float lambda = GammaDistribution.Generate(failures, (1f - probability) / probability);
		...
		{
			float lambda = GammaDistribution.Generate(iidFunc, failures, (1f - probability) / probability);
		...
		{
			float lambda = GammaDistribution.Generate(iidGenerator, failures, (1f - probability) / probability);
