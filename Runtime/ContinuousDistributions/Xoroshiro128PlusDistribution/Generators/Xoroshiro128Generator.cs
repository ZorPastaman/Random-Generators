...
{
	/// <summary>
	/// Xoroshiro128Plus distribution generator using <see cref="Xoroshiro128Plus.NextFloat()"/>.
	/// </summary>
	public sealed class Xoroshiro128PlusGenerator : IXoroshiro128PlusGenerator
	{
		private Xoroshiro128Plus m_randomEngine;

		/// <summary>
		/// Creates a <see cref="Xoroshiro128PlusGenerator"/> with <see cref="Environment.TickCount"/> as seed.
		/// </summary>
		...
		/// <summary>
		/// Creates a <see cref="Xoroshiro128PlusGenerator"/> with the specified parameters.
		/// </summary>
		...
		/// </remarks>
		public Xoroshiro128PlusGenerator(long a, long b)
		{
		...
		/// At least one parameter must be non-zero.
		/// </remarks>
		public Xoroshiro128PlusGenerator(ulong a, ulong b)
		{
			m_randomEngine = new Xoroshiro128Plus(a, b);
		}
