...
namespace Zor.RandomGenerators.ContinuousDistributions.IndependentDistributions
{
	...
	/// </summary>
	public sealed class AcceptanceRejectionCurveRandomGeneratorFuncDependent : IAcceptanceRejectionRandomGenerator
	{
		...
		/// <summary>
		/// Creates an <see cref="AcceptanceRejectionCurveRandomGeneratorFuncDependent"/> with the specified parameters.
		/// </summary>
		...
		/// </param>
		public AcceptanceRejectionCurveRandomGeneratorFuncDependent([NotNull] Func<float> valueFunc,
		...
		/// Copy constructor.
		/// </summary>
		public AcceptanceRejectionCurveRandomGeneratorFuncDependent(
			[NotNull] AcceptanceRejectionCurveRandomGeneratorFuncDependent other)
		{
