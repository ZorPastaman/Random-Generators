...
namespace Zor.RandomGenerators.ContinuousDistributions.IndependentDistributions
{
	...
	/// </summary>
	public sealed class AcceptanceRejectionFuncGenerator : IAcceptanceRejectionGenerator
	{
		...
		/// <summary>
		/// Creates an <see cref="AcceptanceRejectionFuncGenerator"/> with the specified parameters.
		/// </summary>
		...
		/// Copy constructor.
		/// </summary>
		public AcceptanceRejectionFuncGenerator([NotNull] AcceptanceRejectionFuncGenerator other)
		{
