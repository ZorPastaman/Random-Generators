...
namespace Zor.RandomGenerators.ContinuousDistributions.IndependentDistributions
{
	...
	/// </summary>
	public sealed class AcceptanceRejectionFuncGeneratorFuncDependentSimple : IAcceptanceRejectionGenerator
	{
		[NotNull] private Func<float> m_valueFunc;
		[NotNull] private Func<float, float> m_probabilityFunc;

		/// <summary>
		/// Creates an <see cref="AcceptanceRejectionFuncGeneratorFuncDependentSimple"/>
		...
		/// </param>
		public AcceptanceRejectionFuncGeneratorFuncDependentSimple([NotNull] Func<float> valueFunc,
		...
		/// Copy constructor.
		/// </summary>
		public AcceptanceRejectionFuncGeneratorFuncDependentSimple(
			[NotNull] AcceptanceRejectionFuncGeneratorFuncDependentSimple other)
		{
