...
{
	/// <summary>
	/// Provides <see cref="XorShift64GeneratorRangedInclusive"/> with the specified seed.
	/// </summary>
	[CreateAssetMenu(
		menuName = CreateAssetMenuConstants.XorShift64ContinuousDistributionFolder +
			"XorShift64 Generator Ranged Inclusive Provider",
		fileName = "XorShift64GeneratorRangedInclusiveProvider",
		order = CreateAssetMenuConstants.DistributionOrder
	)]
	public sealed class XorShift64GeneratorRangedInclusiveProvider : ContinuousGeneratorProvider
	{
		...
		/// <summary>
		/// Creates a new <see cref="XorShift64GeneratorRangedInclusive"/>
		...
		{
			[Pure]
			get => new XorShift64GeneratorRangedInclusive(m_InitialState, m_Min, m_Max);
		}
