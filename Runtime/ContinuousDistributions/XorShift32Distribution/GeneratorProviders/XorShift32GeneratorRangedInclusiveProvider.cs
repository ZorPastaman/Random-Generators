...
{
	/// <summary>
	/// Provides <see cref="XorShift32GeneratorRangedInclusive"/> with the specified seed.
	/// </summary>
	[CreateAssetMenu(
		menuName = CreateAssetMenuConstants.XorShift32ContinuousDistributionFolder +
			"XorShift32 Generator Ranged Inclusive Provider",
		fileName = "XorShift32GeneratorRangedInclusiveProvider",
		order = CreateAssetMenuConstants.DistributionOrder
	)]
	public sealed class XorShift32GeneratorRangedInclusiveProvider : ContinuousGeneratorProvider
	{
		...
		/// <summary>
		/// Creates a new <see cref="XorShift32GeneratorRangedInclusive"/>
		...
		{
			[Pure]
			get => new XorShift32GeneratorRangedInclusive(m_InitialState, m_Min, m_Max);
		}
