...
{
	/// <summary>
	/// XorShift128 distribution generator using <see cref="XorShift128.NextFloatInclusive(float,float)"/>.
	/// </summary>
	public sealed class XorShift128GeneratorRangedInclusive : IXorShift128Generator
	{
		...
		/// <summary>
		/// Creates a <see cref="XorShift128GeneratorRangedInclusive"/> with the specified min and max
		/// and <see cref="Environment.TickCount"/> as seed.
		/// </summary>
		/// <param name="min"></param>
		/// <param name="max"></param>
		public XorShift128GeneratorRangedInclusive(float min, float max)
		{
		...
		/// <summary>
		/// Creates a <see cref="XorShift128GeneratorRangedInclusive"/> with the specified parameters.
		/// </summary>
		...
		/// </remarks>
		public XorShift128GeneratorRangedInclusive(int a, int b, int c, int d, float min, float max)
		{
		...
		/// </remarks>
		public XorShift128GeneratorRangedInclusive(uint a, uint b, uint c, uint d, float min, float max)
		{
			m_randomEngine = new XorShift128(a, b, c, d);
			m_min = min;
			m_max = max;
		...
		/// <param name="min"></param>
		/// <param name="max"></param>
		public XorShift128GeneratorRangedInclusive((int, int, int, int) seed, float min, float max)
		{
		...
		/// <param name="min"></param>
		/// <param name="max"></param>
		public XorShift128GeneratorRangedInclusive((uint, uint, uint, uint) state, float min, float max)
		{
