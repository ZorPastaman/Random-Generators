...
namespace Zor.RandomGenerators.ContinuousDistributions
{
	...
	/// using <see cref="RejectionDistribution.Generate(Func{float},Func{float},AnimationCurve)"/>.
	/// </summary>
	public sealed class RejectionCurveGeneratorFuncDependent : IRejectionGenerator
	{
		...
		/// <summary>
		/// Creates an <see cref="RejectionCurveGeneratorFuncDependent"/> with the specified parameters.
		/// </summary>
		...
		/// </param>
		public RejectionCurveGeneratorFuncDependent([NotNull] Func<float> valueFunc,
		...
		{
			return RejectionDistribution.Generate(m_valueFunc, m_checkFunc, m_probabilityCurve);
		}
	}
}
