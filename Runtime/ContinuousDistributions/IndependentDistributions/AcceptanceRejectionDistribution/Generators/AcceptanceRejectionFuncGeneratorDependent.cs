...
namespace Zor.RandomGenerators.ContinuousDistributions.IndependentDistributions
{
	...
	/// </summary>
	public sealed class AcceptanceRejectionFuncGeneratorDependent<TValue, TCheck> : IAcceptanceRejectionGenerator
		where TValue : IContinuousGenerator where TCheck : IContinuousGenerator
	{
		...
		/// <summary>
		/// Creates an <see cref="AcceptanceRejectionFuncGeneratorDependent{TValue,TCheck}"/>
		...
		/// </param>
		public AcceptanceRejectionFuncGeneratorDependent([NotNull] TValue valueGenerator,
		...
		/// Copy constructor.
		/// </summary>
		public AcceptanceRejectionFuncGeneratorDependent(
			[NotNull] AcceptanceRejectionFuncGeneratorDependent<TValue, TCheck> other)
		{
