...
namespace Zor.RandomGenerators.ContinuousDistributions.IndependentDistributions
{
	...
	/// </summary>
	public sealed class AcceptanceRejectionCurveRandomGeneratorRandomGeneratorDependent<TValue, TCheck> :
		...
		where TValue : IContinuousRandomGenerator where TCheck : IContinuousRandomGenerator
	{
		...
		/// <summary>
		/// Creates an <see cref="AcceptanceRejectionCurveRandomGeneratorRandomGeneratorDependent{TValue,TCheck}"/>
		...
		/// </param>
		public AcceptanceRejectionCurveRandomGeneratorRandomGeneratorDependent([NotNull] TValue valueGenerator,
		...
		/// Copy constructor.
		/// </summary>
		public AcceptanceRejectionCurveRandomGeneratorRandomGeneratorDependent(
			[NotNull] AcceptanceRejectionCurveRandomGeneratorRandomGeneratorDependent<TValue, TCheck> other)
		{
