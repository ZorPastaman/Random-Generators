...
{
	/// <summary>
	/// Pseudo-random number engine using 64-bit Linear congruential generator algorithm.
	/// </summary>
	public unsafe struct LCG64
	{
		private ulong m_state;

		/// <summary>
		/// Creates a <see cref="LCG64"/> with the specified initial state.
		/// </summary>
		/// <param name="state">Initial state.</param>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public LCG64(ulong state)
		{
			m_state = state;
		}

		/// <summary>
		/// Creates a <see cref="LCG64"/> with the specified seed.
		/// </summary>
		...
		private void NextState()
		{
			unchecked
			{
				m_state = 6364136223846793005UL * m_state + 1UL;
			}
		}
	}
}
