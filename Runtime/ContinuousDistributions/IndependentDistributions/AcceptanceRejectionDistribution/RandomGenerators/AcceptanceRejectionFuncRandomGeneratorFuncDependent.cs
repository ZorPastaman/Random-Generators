...
namespace Zor.RandomGenerators.ContinuousDistributions.IndependentDistributions
{
	...
	/// </summary>
	public sealed class AcceptanceRejectionFuncRandomGeneratorFuncDependent : IAcceptanceRejectionRandomGenerator
	{
		...
		/// <summary>
		/// Creates an <see cref="AcceptanceRejectionFuncRandomGeneratorFuncDependent"/>
		...
		/// </param>
		public AcceptanceRejectionFuncRandomGeneratorFuncDependent([NotNull] Func<float> valueFunc,
		...
		/// Copy constructor.
		/// </summary>
		public AcceptanceRejectionFuncRandomGeneratorFuncDependent(
			[NotNull] AcceptanceRejectionFuncRandomGeneratorFuncDependent other)
		{
