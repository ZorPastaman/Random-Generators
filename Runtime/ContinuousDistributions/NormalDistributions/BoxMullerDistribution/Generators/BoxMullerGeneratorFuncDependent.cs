...
namespace Zor.RandomGenerators.ContinuousDistributions.NormalDistributions
{
	...
	/// </summary>
	public sealed class BoxMullerGeneratorFuncDependent : IBoxMullerGenerator
	{
		...
		/// <summary>
		/// Creates a <see cref="BoxMullerGeneratorFuncDependent"/> with the specified parameters.
		/// </summary>
		/// <param name="iidFunc">
		...
		/// Copy constructor.
		/// </summary>
		public BoxMullerGeneratorFuncDependent([NotNull] BoxMullerGeneratorFuncDependent other)
		{
